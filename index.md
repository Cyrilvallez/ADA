...
{% include imagetextleft.html image="democratic_republican.html" title="blabla" description=">It is observed that the most talked about women are politicians, lawyer, writer, university teacher. The distribution is however highly skewed indicating a huge asymmetry in the representation of occupations in newspapers" %}
